...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "pay.receiversHint": "A slip paid to any account you list here earns points. For a merchant QR (KShop, แม่มณี, …), just upload the QR below — or pick “ร้านค้า / KShop” and enter the Merchant ID shown on the slip.",
    "pay.uploadQr": "Upload shop QR",
    "pay.qrAdded": "Added {name} from the QR",
    "pay.qrNoCode": "No QR code found in that image. Try a clearer photo.",
    "pay.qrNoMerchant": "Couldn't read a Merchant ID from that QR. Upload the shop's merchant QR (KShop / แม่มณี / Thai QR Payment), or enter the Merchant ID manually.",
    "pay.qrError": "Couldn't read that image.",
    ...
    "pay.merchantId": "Merchant ID / wallet number",
    "pay.merchantIdPlaceholder": "e.g. KB000002209056 (from the slip)",
  ...
  th: {
    ...
    "pay.receiversHint": "สลิปที่โอนเข้าบัญชีใดก็ตามในรายการนี้จะได้รับแต้ม สำหรับ QR ร้านค้า (KShop, แม่มณี, …) แค่อัปโหลด QR ด้านล่างได้เลย — หรือเลือก “ร้านค้า / KShop” แล้วกรอกรหัสร้านค้า (Merchant ID) ที่แสดงบนสลิป",
    "pay.uploadQr": "อัปโหลด QR ร้านค้า",
    "pay.qrAdded": "เพิ่ม {name} จาก QR แล้ว",
    "pay.qrNoCode": "ไม่พบ QR ในรูปนี้ ลองใช้รูปที่ชัดขึ้น",
    "pay.qrNoMerchant": "อ่านรหัสร้านค้า (Merchant ID) จาก QR นี้ไม่ได้ กรุณาอัปโหลด QR ร้านค้า (KShop / แม่มณี / Thai QR Payment) หรือกรอกรหัสร้านค้าเอง",
    "pay.qrError": "อ่านรูปนี้ไม่ได้",
    ...
    "pay.merchantId": "รหัสร้านค้า / เลขวอลเล็ท",
    "pay.merchantIdPlaceholder": "เช่น KB000002209056 (อ่านจากสลิป)",
